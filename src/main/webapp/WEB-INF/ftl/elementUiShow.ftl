...
<html>
	<head>
		...
		<meta charset="utf-8">
		<link rel="stylesheet" href="../element-ui-2.0/index.css" />
<script type="text/javascript" src="../js/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="../element-ui-2.0/vue.js"></script>
<script type="text/javascript" src="../element-ui-2.0/index.js"></script>
<style>
  .el-header {
